...
const EditCourse: FC<Props> = ({ id }) => {
  ...
  useEffect(() => {
    if (editCourseData) {
      ...
      setBenefits(editCourseData.prerequisites);
      setBenefits(editCourseData.courseData);
    }
  }, [editCourseData]);
  ...
  return (
    <div className="w-full flex min-h-screen">
      ...
      <div className="w-[20%] invisible sm:visible sm:flex mt-[100px] h-screen fixed z-[-1] top-18 right-0">
